// shared.js — By Train By Foot

function getNavHTML(activePage) {
  return `
  <nav class="site-nav">
    <div class="nav-inner">
      <a href="index.html" class="nav-logo">By Train <span>By Foot</span></a>
      <ul class="nav-primary">
        ...
        <li class="nav-item">
          ...
          <div class="drop-menu">
            ...
            <a href="trails.html">❄️ Snowshoe trails</a>
          </div>
        </li>
        ...
        <li class="nav-item">
          ...
          <div class="drop-menu">
            ...
            <a href="gear.html">📷 Film cameras</a>
          </div>
        </li>
...
function getFooterHTML() {
  ...
  <footer class="site-footer">
    <div class="footer-top">
      <div>
        <div class="footer-logo">By Train <span>By Foot</span></div>
    ...
    <div class="footer-bottom">
      <p class="footer-copy">© 2026 By Train By Foot by Mathias. Made in Switzerland, travelled by train.</p>
